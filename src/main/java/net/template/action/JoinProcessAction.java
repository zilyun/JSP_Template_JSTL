...
public class JoinProcessAction implements Action {
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response)
		...
		join.setId(id); join.setPassword(pass); 
		join.setJumin(jumin); join.setEmail(email);
		join.setGender(gender); join.setHobby(hobby); 
		join.setPost(post1); join.setAddress(address); 
		join.setIntro(intro);
